...
<body>
    ...
    <div id="quesDisplay">
    <div id="questionBox">
     <p id ="questionboxcontent" style="margin-top:100px; margin-left:120px;">DOUBLE CLICK NEXT FOR YOUR QUESTIONS</p>
      </div>
<?php
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <p id ="selectedanswer"> Do you want to proceed with your answer</p>
